...
""" I have made some small edits in the codeacademySQL file to adapt it to Python 3.x"""
...
A chi-squared will be applicable, as we are not testing in samples from a population
but rather on measured values from the entire population 
...
""" As this p-value is < 0.05 we can reject the zero hypothesis and state that there is a 
significant difference in the percentage of users who filed an application in the two tests"""
...
""" As this p-value is > 0.05 we can accept the zero hypothesis and state that there is no
significant difference in the percentage of users who filed an application in the two tests"""
...
"""
As this p-value is < 0.05 we can reject the zero hypothesis and state that there is a 
significant difference between the two tests in the percentage of users who ended up purchasing a membership.
"""
